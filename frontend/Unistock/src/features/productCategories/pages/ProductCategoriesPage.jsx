...
const ProductCategoriesPage = () => {
  ...
  const paginatedProductCategories = filteredProductCategories.slice(startIndex, startIndex + itemsPerPage);
  ...
  if (loading && productCategories.length === 0) return (
    <div style={{ padding: isMobile ? '16px 12px' : '24px 32px' }}>
      ...
      <div style={{
        ...
        boxShadow: '0 1px 4px rgba(0,0,0,0.08)', padding: '12px 20px', marginBottom: '20px',
      }}>
        <div style={{
