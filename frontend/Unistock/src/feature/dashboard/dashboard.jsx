    ...
    <div className="min-h-screen p-5" style={{background: "#fdf6fc"}}>
      ...
      <div className="flex gap-4 mb-4">
        ...
        <Card className="flex-1">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {/* Dropdowns + selector Semana/Mes/Año líneas */}
            <div className="flex items-center gap-2">
              {timeView === 'Semana' && <>
          ...
          <ResponsiveContainer width="100%" height={280}>
            <LineChart data={lineData} margin={{ top: 5, right: 10, left: -5, bottom: 0 }}>
              ...
              <YAxis domain={[0, 330]} ticks={[0,30,60,90,120,150,180,210,240,270,300,330]}
                ...
                label={{ value: 'Órdenes de producción', angle: -90, position: 'insideLeft',
      ...
      <Card>
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2">
            {/* Dropdowns según vista */}
            {barTimeView === 'Semana' && <>
              <Dropdown value={selectedBarMonth} options={MONTHS} onChange={setSelectedBarMonth} />
              <Dropdown value={selectedBarYear}  options={YEARS}  onChange={setSelectedBarYear}  />
            </>}
            {barTimeView === 'Mes' && (
              <Dropdown value={selectedBarMonth} options={MONTHS} onChange={setSelectedBarMonth} />
            )}
        ...
        <ResponsiveContainer width="100%" height={280}>
          <BarChart data={barData} margin={{ top: 5, right: 10, left: 0, bottom: 60 }} barCategoryGap="28%">
            <CartesianGrid strokeDasharray="2 4" stroke="#F5D8F5" vertical={false} />
