      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
          ...
          <div className="px-6 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 text-center">
                    ...
                    <img 
                      src={product.image} 
                      alt={product.name} 
                      className="w-24 h-24 object-cover rounded-lg mx-auto border-2 border-white shadow-sm"
                    />
              ...
              <div className="space-y-4">
                <HoverCard
                  content={
                    <div>
                      <p className="font-medium mb-2">Categoría del producto</p>
                ...
                <HoverCard
                  content={
                    <div>
                      <p className="font-medium mb-2">Precio de venta</p>
                      <p className="text-sm">Peso Colombiano (COP)</p>
                    </div>
                  }
                >
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            {/* SECCIÓN FICHA TÉCNICA - Solo resumen con botón */}
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Versión {product.technicalSheetVersions || 1} • 
                        Última actualización: {product.lastVersionDate || '2026-02-13'}
                      </p>
                    </div>
                  </div>
                  <button
