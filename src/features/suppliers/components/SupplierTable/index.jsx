...
const SupplierTable = ({ suppliers = [], onView, onEdit, onDelete, onToggle }) => {
  ...
  return (
    <div style={{ backgroundColor: "#fff", borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.06)", overflow: "hidden" }}>
      {/* min-width fuerza el scroll horizontal en vez de aplastar las columnas a 1 letra */}
                  ...
                  <td style={tdActionsStyle} onClick={(e) => e.stopPropagation()}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      ...
                      <button
                        ...
                        style={{
                          position: "relative", width: "44px", minWidth: "44px", height: "24px", minHeight: "24px",
                          flexShrink: 0, boxSizing: "border-box", borderRadius: "20px", border: "none",
                          backgroundColor: isActive ? "#22c55e" : "#d1d5db", cursor: "pointer", padding: 0,
                        }}>
                        <span style={{
                          position: "absolute", top: "2px", left: isActive ? "22px" : "2px",
                          width: "20px", height: "20px", minWidth: "20px", minHeight: "20px",
                          borderRadius: "50%", backgroundColor: "#fff", transition: "0.2s", boxSizing: "border-box",
                        }} />
                      </button>
                    </div>
                  </td>
