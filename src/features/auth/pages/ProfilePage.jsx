...
const SectionCard = ({ title, subtitle, children }) => (
  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
    <div className="flex items-stretch">
      ...
      <div className="flex-1 px-4 sm:px-6 py-3.5">
        <div className="mb-3">
...
const ProfilePage = () => {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="px-4 sm:px-8 pb-4 flex flex-col gap-3">
        ...
        <SectionCard title="Cambiar contraseña" subtitle="Usa una contraseña de al menos 8 caracteres">
          ...
          {newPassword.length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-1 sm:gap-y-0.5 mb-3 px-3 py-2 bg-gray-50 rounded-lg border border-gray-100">
