...
const UserTable = ({ users = [], getRolNombre, getSedeNombre, onEdit, onDelete, onToggle }) => {
  ...
  const renderRow = (user) => {
    ...
    // El usuario con rol "Gerente" es único en el sistema y no se puede editar,
    // eliminar ni cambiar de estado — ni siquiera por el propio Gerente sobre
    // sí mismo. Se bloquea acá a nivel de fila, igual que en RolTable.
    const esGerente = rolNombre?.toString().trim().toLowerCase() === "gerente";
